 ...
 */
export async function consultarKPIsFinanceirosIA(
 ...
 */
export async function consultarInadimplenciaIA(
  sb: SupabaseClient<Database>,
  params: { apenas_vencidos?: boolean }
) {
 ...
 */
export async function compararPeriodosIA(
  sb: SupabaseClient<Database>,
  params: { p1: { from: string; to: string }; p2: { from: string; to: string } }
) {
