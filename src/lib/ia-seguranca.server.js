 ...
 */
export function sanitizarEntradaIa(texto, limite = LIMITE_PADRAO) {
    if (texto == null)
        return "";
    let t = String(texto);
    ...
    t = t.replace(/[\u0000-\u0008\u000B\u000C\u000E-\u001F\u007F]/g, " ");
    t = t.replace(/[\u200B-\u200F\u202A-\u202E\u2060-\u206F\uFEFF]/g, "");
    for (const p of PADROES_INJECAO)
        t = t.replace(p, "[trecho removido]");
...
export function blocoDeDados(rotulo, texto, limite = LIMITE_PADRAO) {
 ...
 */
export function sanitizarPromptFinal(prompt, limite = 12000) {
